/* SIAP GURU — LOGIN VISUAL v6
 * VISUAL ONLY. Authentication, form IDs, handlers and backend remain untouched.
 * New original visual direction inspired by modern education SaaS patterns.
 */
(function(){
'use strict';
if(window.__SIAP_GURU_LOGIN_UI_V6__)return;
window.__SIAP_GURU_LOGIN_UI_V6__=true;
const css=`
...
body.v10-login #loginScreen .sg-login-benefit-icon{display:block!important;margin-bottom:8px!important;font-size:20px!important}
...
body.v10-login #loginScreen .login-mid{width:min(460px,100%)!important;display:block!important}
body.v10-login #loginScreen .sg-login-showcase{display:none!important}
body.v10-login #loginScreen .sg-login-card-wrap{display:block!important;padding:25px 22px!important;border:1px solid rgba(148,163,184,.24)!important;border-radius:24px!important;background:rgba(255,255,255,.98)!important;box-shadow:0 22px 60px rgba(20,62,110,.14)!important}
body.v10-login #loginScreen .login-card{max-width:410px!important;margin:0 auto!important}
}
@media(max-width:520px){
body.v10-login #loginScreen.login{padding:12px 9px!important}
body.v10-login #loginScreen .sg-login-card-wrap{padding:21px 18px!important;border-radius:20px!important}
body.v10-login #loginScreen .login-card-title{font-size:23px!important}
body.v10-login #loginScreen .login-card-mini{margin-bottom:22px!important}
}
`;
function buildVisual(){
  ...
  mid.insertBefore(showcase,card);
...
function boot(){
 let s=document.getElementById('siapGuruLoginUIV6Style');
 if(!s){s=document.createElement('style');s.id='siapGuruLoginUIV6Style';s.textContent=css;document.head.appendChild(s)}
 const t=document.querySelector('#loginScreen .login-brand-title');if(t)t.textContent='SIAP GURU';
 buildVisual();
}

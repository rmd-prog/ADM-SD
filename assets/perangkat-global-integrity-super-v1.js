/* GURU+ SD — GLOBAL INTEGRITY SUPER V5
 ...
 */
(function(){'use strict';
if(window.__GURU_SD_GLOBAL_INTEGRITY_V5__)return;window.__GURU_SD_GLOBAL_INTEGRITY_V5__=1;
...
async function boot(){
  ...
  audit();window.dispatchEvent(new CustomEvent('guruSdSuperReady'));
}
...
window.GURU_SD_GLOBAL_INTEGRITY={audit,master,legacyKeys:LEGACY.slice(),canonical:true};
})();
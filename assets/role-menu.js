/* ADM-SD — role menu + AI Brain V4.1.1 loader */
(function(){
'use strict';
...
function boot(){applyRoleMenu();loadScript('assets/multi-rombel.js?v=1','__ADM_MULTI_ROMBEL_LOADED');loadScript('assets/ai-brain-v41.js?v=411','__ADM_AI_V41_LOADED');window.__ADM_APPLY_ROLE_MENU=applyRoleMenu}
if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',boot,{once:true});else boot();
const obs=new MutationObserver(()=>{if(!window.__ADM_AI_V41_LOADED)loadScript('assets/ai-brain-v41.js?v=411','__ADM_AI_V41_LOADED')});if(document.body)obs.observe(document.body,{childList:true,subtree:true});
})();

...
(function(){
  ...
  function inject(){
    ...
    document.getElementById('gmReset')?.addEventListener('click',()=>['gmNama','gmUsername','gmPassword'].forEach(x=>{const e=document.getElementById(x);if(e)e.value=''}));
    load();
  }
  ...
  if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',()=>setTimeout(hook,0),{once:true});else setTimeout(hook,0);
})();
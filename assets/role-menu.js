/* ADM-SD — role menu + AI Brain V3.9 loader */
(function(){
'use strict';
...
function boot(){applyRoleMenu();loadScript('assets/multi-rombel.js?v=1','__ADM_MULTI_ROMBEL_LOADED');loadScript('assets/ai-brain-v39.js?v=39','__ADM_AI_V39_LOADED');window.__ADM_APPLY_ROLE_MENU=applyRoleMenu}
if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',boot,{once:true});else boot();
const obs=new MutationObserver(()=>{if(!window.__ADM_AI_V39_LOADED)loadScript('assets/ai-brain-v39.js?v=39','__ADM_AI_V39_LOADED')});
